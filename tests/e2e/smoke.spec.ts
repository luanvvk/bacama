...
const publicRoutes = [
  ...
  ['/story', 'Một gian bếp, một lò nướng, một gia đình.'],
  ['/login', 'Welcome back'],
  ['/register', 'Create your account'],
  ['/faq', 'Các câu hỏi thường gặp.'],
  ['/contact', 'Ghé qua, gọi điện, hoặc viết cho chúng tôi.'],
  ['/subscribe', 'Những điều hay, không thường xuyên.'],
  ['/shipping-returns', 'Từ lò của chúng tôi đến trước cửa nhà bạn.'],
  ['/terms', 'Điều khoản & điều kiện.'],
  ['/privacy', 'Chính sách quyền riêng tư.'],
  ['/wholesale', 'Giá thật, điều khoản thật.'],
  ['/gift-cards', 'Tặng họ một buổi sáng ở Bacama.'],
  ['/accessibility', 'Một tiệm được làm ra để ai cũng dùng được.'],
  ['/careers', 'Việc tốt là do người tốt làm ra.'],
  ['/press', 'Một câu chuyện nhỏ, được kể đúng sự thật.'],
