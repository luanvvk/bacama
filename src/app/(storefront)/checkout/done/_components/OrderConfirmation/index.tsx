      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:gap-14">
        <div className="flex flex-col gap-6">
          <div className="rounded-lg border p-4">
            <p className="font-heading text-base font-medium">Where your parcel is</p>
            <div className="mt-4">
              <OrderTracker steps={trackerSteps} />
            </div>
            <p className="text-muted-foreground mt-4 text-sm">
              Your coffee rides tomorrow morning&rsquo;s batch — packed as soon as it cools and
              shipped the same afternoon. The tracking number arrives over Zalo the moment GHN picks
              up.
            </p>
          </div>
        ...
        <OrderSummary
          ...
          totalLabel={isCod ? 'Due on delivery' : 'Paid'}
          shipTo={{
